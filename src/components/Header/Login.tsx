        ...
        <div className={"absolute top-17 bg-white py-1 px-2 rounded flex flex-col shadow transtion-all duration-200 " + (open ? "opacity-100 visible" : "opacity-0 invisible")}>
          <div className="flex flex-col py-3 px-1">
            ...
            <div className="border-t-2 border-gray-100">
              ...
              <div>
                <Popup title={active === 'girmek' ? t(('login')) : t(('signUp'))} open={openLogin} setOpen={setOpenLogin} sendData={sendData} active={active} setActive={setActive}>
                  <div className='my-5'>
                  ...
                  </div>
                  {
                    active === 'agza bolmak' &&
                    <div className='mb-4'>
                      <Input name='passwordConfirm' label="Parolynyzy tassyklan" type='password' onChange={handleData} value={data.passwordConfirm} />
                    </div>
                  }
                  <div className='mb-3'>
